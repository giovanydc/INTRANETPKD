  ...
  <div class="row row-cols-2 row-cols-md-1">
    ...
    <div class="col"><a href="https://www.pacada.com.mx/EduFin.html" class="footer-link">Educación Financiera</a></div>
      ...
      <div class="col-md-3 mb-4">
        ...
        <p class="footer-contact"><i class="bi bi-telephone-fill icon"></i>Ext 2060 (A/A Ing. Adolfo Cortes)</p>
        <p class="footer-contact"><i class="bi bi-telephone-fill icon"></i>Ext 2069 (A/A Lic. Giovany De la luz)</p>
